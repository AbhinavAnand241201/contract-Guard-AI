          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm">Our intelligent engine processes the text in seconds for risks and explanations.</p>
              </div>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Practice & Prepare</h3>
                <p className="text-muted-foreground text-sm">Use the AI Simulator to practice negotiations and build confidence.</p>
              </div>
              <div className="p-6">
                <div className="bg-primary text-primary-foreground rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-md">4</div>
                <h3 className="text-xl font-semibold mb-2">Get Insights & Protection</h3>
